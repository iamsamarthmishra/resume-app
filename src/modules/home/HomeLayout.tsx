    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: [0, 1] }} className="scroll-smooth">
      <nav className="sticky top-0 z-20 h-14 w-full bg-resume-800 flex py-2.5 px-4 xl:px-60 items-center shadow-level-8dp">
        ...
        <div className="flex-auto flex justify-between items-center ml-5">
          <NavBarActions>
            <Link href="https://metaedschool.com" passHref={true}>
              <StyledButton variant="text">MetaEd School</StyledButton>
            </Link>
          </NavBarActions>
          <NavBarActions>
            ...
            <a
              href={'https://github.com/iamsamarthmishra/resume-app'}
              target="_blank"
      ...
      >
        ...
        <p className="text-resume-400 my-8 text-center lg:text-left">
          Design & Build by&nbsp;
          <a
            href="https://growthflexstudios.online"
            target="_blank"
            rel="noreferrer"
            className="underline"
          >
